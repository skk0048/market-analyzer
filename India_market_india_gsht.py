"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  INDIA MARKET ANALYSIS — GOOGLE SHEETS EDITION  v5.3                      ║
...
║   • RS Sleeve Lists sheet (A=Large/Monthly, B=Growth/Ftn, C=Agg/Weekly)  ║
║   • Dashboard run_time now in correct IST string (was showing UTC offset) ║
║   • rs22% added to GS breadth coloring                                    ║
║                                                                            ║
║  HOW TO AUTHENTICATE:                                                      ║
...
║   5. 📊 Market Breadth   12. 📋 RS Sleeve Lists  ← NEW                    ║
║   6. 📈 Sector Perf.                                                       ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
from market_engine import (
    ...
    fetch_ohlcv_with_cache, _normalize,
...
def main():
    print("\n" + "═" * 68)
    print("  INDIA MARKET — GOOGLE SHEETS EDITION  v5.3")
    ...
    print("\n📡 Sector indices …"); sector_prices = fetch_india_sector_prices()
